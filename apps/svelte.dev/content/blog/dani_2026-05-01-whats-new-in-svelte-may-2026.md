...
- Form `submit` now returns a `boolean` to indicate submission validity for enhanced form remote function (**2.57.0**, [Docs](https://svelte.dev/docs/kit/app-forms#enhance), [#15530](https://github.com/sveltejs/kit/pull/15530))
...
- `form` fields can now specify a default value using `(field.as(type, value))` (**2.56.0**, [Docs](https://svelte.dev/docs/kit/remote-functions#form-Fields), [#15577](https://github.com/sveltejs/kit/pull/15577))
- Remote function transport is now more reliable thanks to `hydratable` (**2.56.0**, [#15533](https://github.com/sveltejs/kit/pull/15533))
...
- [dnsoptic](https://dnsoptic.com/) is a DNS health audit tool that checks nameservers, mail authentication,
DNSSEC, security posture, and migration diffs
...
- [The 12 Principles of Animation](https://overshoot.dev/) by Allan Raffel
